...
---@class OrgAgendaTodoKeywordsTypeOpts
...
---@class OrgAgendaTodoKeywordsType:OrgAgendaViewType
---@field files OrgFiles
---@field highlighter OrgHighlighter
---@field agenda_filter OrgAgendaFilter
...
---@field id? string
local OrgAgendaTodoKeywordsType = {}
OrgAgendaTodoKeywordsType.__index = OrgAgendaTodoKeywordsType

---@param opts OrgAgendaTodoKeywordsTypeOpts
function OrgAgendaTodoKeywordsType:new(opts)
...
function OrgAgendaTodoKeywordsType:prepare()
  return Promise.resolve(self)
end

function OrgAgendaTodoKeywordsType:_setup_agenda_files()
...
function OrgAgendaTodoKeywordsType:redo()
  if self.agenda_files then
    self.files:load_sync(true)
  end
end

function OrgAgendaTodoKeywordsType:_get_header()
  if self.header then
    return self.header
  end
  return 'Global list of TODO items of type: ' .. table.concat(self.todo_keywords, ' | ')
end

---@param bufnr? number
function OrgAgendaTodoKeywordsType:render(bufnr)
...
function OrgAgendaTodoKeywordsType:_build_line(headline, metadata)
...
---@return OrgAgendaLine[]
function OrgAgendaTodoKeywordsType:get_lines()
  return self.view.lines
end

---@param row number
---@return OrgAgendaLine | nil
function OrgAgendaTodoKeywordsType:get_line(row)
...
---@param headline OrgHeadline
function OrgAgendaTodoKeywordsType:rerender_agenda_line(agenda_line, headline)
...
---@param file OrgFile
---@return OrgHeadline[]
function OrgAgendaTodoKeywordsType:get_file_headlines(file)
  return file:get_headlines_by_todo_keywords(self.todo_keywords)
end

---@return OrgHeadline[], number
function OrgAgendaTodoKeywordsType:_get_headlines()
  local items = {}
...
function OrgAgendaTodoKeywordsType:_matches_filters(headline)
...
---@return OrgHeadline[]
function OrgAgendaTodoKeywordsType:_sort(todos)
  ---@param headline OrgHeadline
...
return OrgAgendaTodoKeywordsType
